          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: const Icon(Icons.mic, size: 56, color: AppColors.buttonBlue),
              ),
              const SizedBox(height: 24),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Start Screening', style: AppTextStyles.buttonText),
                ),
              ),
              const SizedBox(height: 32),
              Card(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: const [
                      ...
                      SizedBox(height: 12),
                      _Step('1', 'Record respiratory sound using your phone mic'),
                      SizedBox(height: 8),
